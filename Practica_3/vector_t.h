...
/**
 * @brief Metodo que construye un vector_t
 * 
 * @tparam T 
 */
...
/**
 * @brief Metodo que destruye un vector_t
 * 
 * @tparam T 
 */
...
/**
 * @brief Metodo que redimensiona un vector_t
 * 
 * @tparam T 
 * @param n 
 */
...
/**
 * @brief Metodo que obtiene un valor de un vector_t
 * 
 * @tparam T 
 * @param i 
 * @return T 
...
/**
 * @brief Metodo que obtiene el tamaño de un vector_t
 * 
 * @tparam T 
 * @return int 
 */
...
/**
 * @brief Metodo que establece un valor en un vector_t
 * 
 * @tparam T 
 * @param i 
 * @param d 
...
/**
 * @brief Metodo que accede a una posicion concreta de un vector_t
 * 
 * @tparam T 
 * @param i 
 * @return T& 
...
/**
 * @brief Metodo que accede a un elemento concreto de un vector_t para constante
 * 
 * @tparam T 
 * @param i 
 * @return const T& 
...
/**
 * @brief Metodo para la lectura de elementos y guardarlos en un vector_t
 * 
 * @tparam T 
 * @param is 
 */
...
/**
 * @brief Metodo que escribe un vector_t por pantalla
 * 
 * @tparam T 
 * @param os 
 */

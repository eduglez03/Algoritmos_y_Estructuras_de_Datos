...
/**
 * @brief Destroy the dll t<T>::dll t object
 * 
 * @tparam T 
 */
...
// operaciones
/**
 * @brief Mete un elemento al principio de la lista
 * 
 * @tparam T 
 * @param nodo 
 */
...
/**
 * @brief Mete un elemento al final de la lsita
 * 
 * @tparam T 
 * @param nodo 
 */
...
/**
 * @brief Saca un elemento del final de la lista
 * 
 * @tparam T 
 * @return dll_node_t<T>* 
 */
...
/**
 * @brief Saca un elemento del comienzo de la lista
 * 
 * @tparam T 
 * @return dll_node_t<T>* 
 */
